...
//    }
    ...
    public void methodSourceTest(double a, double b, double expectedResut, Calculator.Type type){
    ...
    @ParameterizedTest
    @ValueSource(ints = {-10, 0, 27, 94347859, -487529395})
    ...
    public void calculationsTypeTest(Calculator.Type type) {
        double a = 15;
        double b = 6;
